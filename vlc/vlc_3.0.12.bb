...
DEPENDS = "coreutils-native fribidi libtool libgcrypt libgcrypt-native \
   dbus libxml2 gnutls mpeg2dec faad2  \
   tremor  ffmpeg flac alsa-lib \
...
#x264 
PACKAGECONFIG ?= " \
    live555 dc1394 dv1394 notify fontconfig fluidsynth freetype dvdread png x264  vpx wayland qt5 \
...
#do_install() {
#   install -d ${D}/${libdir}
#   install -m 0755 ${WORKDIR}/libGL.so ${D}/${libdir}
#}
